...
namespace DoAn_NT106
{
    public partial class FormDangKy : Form
    {
        ...
        //Trạng thái hiển thị của password và confirmpassword
        ...
        private async void btn_register_Click(object sender, EventArgs e)
        {
            ...
            if (!chkNotRobot.Checked)
            {
                ...
                MessageBox.Show("⚠ Please verify the captcha.",
                                "Validation error",
                                MessageBoxButtons.OK,
                                MessageBoxIcon.Warning);
                chkNotRobot.Focus();
            ...
            if (!isEmail && !isPhone)
            {
                ...
                MessageBox.Show("⚠ Please enter a valid Email or Phone number.",
                                "Validation error",
                                MessageBoxButtons.OK,
                                MessageBoxIcon.Warning);
                return;
            ...
            {   lblPasswordError.Text = "⚠ Weak password. Must contain ≥8 chars, upper/lowercase, number, symbol.";
                ...
                MessageBox.Show("⚠ Weak password. Must contain ≥8 chars, upper/lowercase, number, symbol.",
                                "Validation error",
                                MessageBoxButtons.OK,
                                MessageBoxIcon.Warning);
                return;
